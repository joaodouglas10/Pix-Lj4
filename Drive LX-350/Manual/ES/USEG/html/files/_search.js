...
function searchLinks(links, keyword){
	...
	document.writeln("<meta NAME=\"Version\" CONTENT=\"BPS0132-01 ES\">");
	document.writeln("<title>Resultados de la búsqueda</title>");
	...
	document.writeln("<div class=\"extra-head\">Resultados de la búsqueda</div>");

	document.writeln("<div class=\"extra-text\">");
	document.writeln("Resultados de la búsqueda de: <B>" +keyword.toUpperCase() +"</B>");
	...
	document.writeln("Si no encuentra los resultados que busca, consulte Consejos de búsqueda.");
	document.writeln("</div>");
	document.writeln("<div class=\"extra-link\">");
	
	document.writeln("<a href=\"javascript:goMain(\'sch.htm\')\">Consejos de búsqueda</a>");
...
descArray[arraycount] = "0 barrado"
	
arraycount += 1
	
namesArray[arraycount] = "Accesorios opcionales"
urlsArray[arraycount] = "optn_1.htm#S-00800-00100-00100"
descArray[arraycount] = "soporte de rollo de papel"
	
arraycount += 1
	
namesArray[arraycount] = "Ajuste"
urlsArray[arraycount] = "paper_3.htm#S-00300-00500-00400"
descArray[arraycount] = "palanca de grosor del papel"
	
arraycount += 1
	
namesArray[arraycount] = "Ajuste"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00300"
descArray[arraycount] = "posición de corte"
...
descArray[arraycount] = "posición de inicio de página"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_6.htm#S-00400-00900"
descArray[arraycount] = "Ajuste Bi-D"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02400"
descArray[arraycount] = "Ajuste del avisador acústico"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_7.htm#S-00400-01000"
descArray[arraycount] = "Ajustes de la impresora"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_5.htm#S-00600-00500"
descArray[arraycount] = "Alineación de líneas verticales"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00700"
descArray[arraycount] = "Alineación del papel"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00600"
descArray[arraycount] = "Área imprimible recomendada"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "custo_2.htm#S-00700-00200-00100"
descArray[arraycount] = "Asistencia técnica"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "Atasco de papel, solucionar"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "custo_2.htm#S-00700-00200-00100"
descArray[arraycount] = "Atención al cliente"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00400"
descArray[arraycount] = "Auto LF"
...
descArray[arraycount] = "Botones"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_9.htm#S-00400-00700"
descArray[arraycount] = "Cancelación de la impresión"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "optn_2.htm#S-00800-00200-00100"
descArray[arraycount] = "Cartucho de cinta"
...
namesArray[arraycount] = "Cliente"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00300"
descArray[arraycount] = "con Windows 7, Vista, XP o 2000"
	
arraycount += 1
	
namesArray[arraycount] = "Configuración predeterminada"
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100"
descArray[arraycount] = "lista de opciones"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "custo_2.htm#S-00700-00200-00100"
descArray[arraycount] = "Contacto con Epson"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_2.htm#S-00400-00200"
descArray[arraycount] = "Controlador (controlador de la impresora)"
	
arraycount += 1
	
namesArray[arraycount] = "Controlador de impresora"
urlsArray[arraycount] = "soft_10.htm#S-00400-00800"
descArray[arraycount] = "desinstalar"
	
arraycount += 1
	
namesArray[arraycount] = "Controlador de la impresora"
urlsArray[arraycount] = "soft_3.htm#S-00400-00300"
descArray[arraycount] = "acceso"
	
arraycount += 1
	
namesArray[arraycount] = "Controlador de la impresora"
urlsArray[arraycount] = "soft_4.htm#S-00400-00400"
descArray[arraycount] = "ajustes"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600"
descArray[arraycount] = "Cortar"
	
arraycount += 1
	
namesArray[arraycount] = "Cortar"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00300"
descArray[arraycount] = "ajuste"
	
arraycount += 1
	
namesArray[arraycount] = "Cortar"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00200"
descArray[arraycount] = "automáticamente"
	
arraycount += 1
	
namesArray[arraycount] = "Corte"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00100"
descArray[arraycount] = "botón"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00300"
descArray[arraycount] = "Corte de papel automático"
	
arraycount += 1
	
namesArray[arraycount] = "Desinstalar"
urlsArray[arraycount] = "soft_10.htm#S-00400-00800"
descArray[arraycount] = "software de impresora"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "Dirección de impresión"
...
descArray[arraycount] = "configuración"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_1.htm#S-00600-00100"
descArray[arraycount] = "Error de indicación"
...
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00700"
descArray[arraycount] = "alineación del papel"
...
descArray[arraycount] = "eléctricas"
	
arraycount += 1
	
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "electrónicas"
	
arraycount += 1
	
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_4.htm#S-00900-00400"
descArray[arraycount] = "estándares y homologaciones"
	
arraycount += 1
	
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "fuente incorporada"
	
arraycount += 1
	
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "juegos de caracteres internacionales"
	
arraycount += 1
	
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_3.htm#S-00900-00300-00300"
descArray[arraycount] = "listas de comandos"
...
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00100"
descArray[arraycount] = "mecánicas"
	
arraycount += 1
	
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00400"
descArray[arraycount] = "medioambientales"
	
arraycount += 1
	
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "papel"
	
arraycount += 1
	
namesArray[arraycount] = "Especificaciones"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "tablas de caracteres"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "Especificaciones del papel"
	
arraycount += 1
	
namesArray[arraycount] = "Extraer"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00200"
descArray[arraycount] = "documento impreso del"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02200"
descArray[arraycount] = "Fuente"
	
arraycount += 1
	
namesArray[arraycount] = "Fuente incorporada"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
...
descArray[arraycount] = "selección"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02200"
descArray[arraycount] = "Grupo internacional de caracteres para tabla cursiva"
	
arraycount += 1
	
namesArray[arraycount] = "Hojas sueltas"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "especificaciones"
	
arraycount += 1
	
namesArray[arraycount] = "Hojas sueltas"
urlsArray[arraycount] = "paper_2.htm#S-00300-00400"
descArray[arraycount] = "impresión"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "Impresión en dos sentidos (Bi-d)"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "Impresión en un sentido (Uni-d)"
	
arraycount += 1
	
namesArray[arraycount] = "Impresora"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00100"
descArray[arraycount] = "compartir"
	
arraycount += 1
	
namesArray[arraycount] = "Impresos de varias copias"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "especificaciones"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "Indicadores luminosos"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00900"
descArray[arraycount] = "interfaz USB"
	
arraycount += 1
	
namesArray[arraycount] = "Interfaz USB"
urlsArray[arraycount] = "trble_3.htm#S-00600-00300"
descArray[arraycount] = "problemas"
...
descArray[arraycount] = "Limpieza de la impresora"
	
arraycount += 1
	
namesArray[arraycount] = "Lista de comandos"
urlsArray[arraycount] = "apspe_3.htm#S-00900-00300-00100"
descArray[arraycount] = "ESC/P"
...
descArray[arraycount] = "Longitud de datos"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00100"
descArray[arraycount] = "Longitud de página para tractor"
	
arraycount += 1
	
namesArray[arraycount] = "Mando"
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "impresora"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00500"
descArray[arraycount] = "microajuste"
...
descArray[arraycount] = "Modo ajustes por defecto"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01900"
descArray[arraycount] = "Modo bajo ruido"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01100"
descArray[arraycount] = "Modo bidireccional de interfaz paralela"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_2.htm#S-00500-00300"
descArray[arraycount] = "Modo de bloqueo"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00900"
descArray[arraycount] = "Modo I/F (interfaz)"
	
arraycount += 1
	
namesArray[arraycount] = "Modo latente"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100-00300"
descArray[arraycount] = "operaciones del panel"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01200"
descArray[arraycount] = "Modo paquete"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "Panel de control"
...
namesArray[arraycount] = "Panel de control"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "botones"
...
namesArray[arraycount] = "Papel continuo"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "especificaciones"
...
descArray[arraycount] = "Paridad"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01400"
descArray[arraycount] = "Paso"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01300"
descArray[arraycount] = "Retorno de carro automático"
	
arraycount += 1
	
namesArray[arraycount] = "Rollo de papel"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "especificaciones"
...
descArray[arraycount] = "Salto sobre la perforación"
	
arraycount += 1
	
namesArray[arraycount] = "Servidor"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00200"
descArray[arraycount] = "en Windows 7, Vista, XP o 2000"
	
arraycount += 1
	
namesArray[arraycount] = "Sobres"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "especificaciones"
...
descArray[arraycount] = "configuración predeterminada"
	
arraycount += 1
	
namesArray[arraycount] = "Solución de problemas"
urlsArray[arraycount] = "trble_3.htm#S-00600-00300"
descArray[arraycount] = "problemas de USB"
	
arraycount += 1
	
namesArray[arraycount] = "Solución de problemas"
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "solución de atascos de papel"
...
namesArray[arraycount] = "Tabla de caracteres"
...
namesArray[arraycount] = "Tabla de caracteres IBM"
...
descArray[arraycount] = "Temporizador de apagado"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02300"
descArray[arraycount] = "Tiempo de espera de carga de papel"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01000"
descArray[arraycount] = "Tiempo de espera I/F automático (interfaz)"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_6.htm#S-00900-00600"
descArray[arraycount] = "Transporte de la impresora"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01500"
descArray[arraycount] = "Velocidad en baudios"
...
document.write("<title>Resultados de la búsqueda</title><body bgcolor=white>");
