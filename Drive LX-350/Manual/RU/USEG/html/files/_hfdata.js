...
function foot_data(strpath, strindexpath)
{
	...
	document.write("<td class=\"foot-text\"><a href=\"index.htm\">Основная страница</a></td>\n");
	...
	document.write("<td class=\"foot-text\"><a href=\"javascript:winOpen\(\'epsonwin2\',\'htmltoc.htm\',0,0,385,iheight-150\)\" >Содержание</a></td>\n");
		...
		document.write("<td class=\"foot-text\"><a href=\"javascript:winOpen\(\'epsonwin3\',\'indexx.htm\',0,40,385,iheight-150\)\" >Предметный указатель</a></td>\n");
	
		document.write("<td width=\"15\"><img src=\"files/15.gif\"></td>\n");
		document.write("<td><a href=\"help.htm\"><img border=0 alt=\"\" src=\"files/top_help.gif\"></a></td>\n");
		document.write("<td class=\"foot-text\"><a href=\"help.htm\">Справка</a></td>\n");
	...
	document.write("<tr><td height=\"30\" class=\"code-text\"><img src=\"files/_fcopy.gif\" align=\"top\">(BPS0132-01 RU)</td></tr>\n");
