...
function searchLinks(links, keyword){
	...
	document.writeln("<meta NAME=\"Version\" CONTENT=\"BPS0132-01 PT\">");
	document.writeln("<title>Resultados da procura</title>");
	...
	document.writeln("<div class=\"extra-head\">Resultados da procura</div>");

	document.writeln("<div class=\"extra-text\">");
	document.writeln("Resultados da procura por : <B>" +keyword.toUpperCase() +"</B>");
	...
	document.writeln("Se não conseguir encontrar os resultados que procura, consulte Conselhos de Procura.");
	document.writeln("</div>");
	document.writeln("<div class=\"extra-link\">");
	
	document.writeln("<a href=\"javascript:goMain(\'sch.htm\')\">Conselhos de Procura</a>");
...
descArray[arraycount] = "0 traço"
	
arraycount += 1
	
namesArray[arraycount] = "Ajustar"
urlsArray[arraycount] = "paper_3.htm#S-00300-00500-00400"
descArray[arraycount] = "alavanca de espessura do papel"
	
arraycount += 1
	
namesArray[arraycount] = "Ajustar"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00300"
descArray[arraycount] = "posição de corte"
...
descArray[arraycount] = "posição de topo de página"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_6.htm#S-00400-00900"
descArray[arraycount] = "Ajuste bidireccional"
...
descArray[arraycount] = "com Windows 7, Vista, XP ou 2000"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00100"
descArray[arraycount] = "Comprimento da página para o tractor"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01700"
descArray[arraycount] = "Comprimento dos dados"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02400"
descArray[arraycount] = "Configuração de alarme (sinal sonoro)"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "Conjuntos de caracteres internacionais"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02200"
descArray[arraycount] = "Conjuntos de caracteres internacionais para tabela de caracteres em itálico"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "custo_2.htm#S-00700-00200-00100"
descArray[arraycount] = "Contactar Epson"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_2.htm#S-00400-00200"
descArray[arraycount] = "Controlador (controlador de impressão)"
	
arraycount += 1
	
namesArray[arraycount] = "Controlador de impressão"
urlsArray[arraycount] = "soft_3.htm#S-00400-00300"
descArray[arraycount] = "aceder"
	
arraycount += 1
	
namesArray[arraycount] = "Controlador de impressão"
urlsArray[arraycount] = "soft_3.htm#S-00400-00300-00300"
descArray[arraycount] = "definições"
...
namesArray[arraycount] = "Especificações"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00700"
descArray[arraycount] = "alinhamento do papel"
...
descArray[arraycount] = "ambientais"
...
namesArray[arraycount] = "Especificações"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00100"
descArray[arraycount] = "mecânicas"
	
arraycount += 1
	
namesArray[arraycount] = "Especificações"
urlsArray[arraycount] = "apspe_4.htm#S-00900-00400"
descArray[arraycount] = "normas e certificações"
...
namesArray[arraycount] = "Especificações"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "tabelas de caracteres"
	
arraycount += 1
	
namesArray[arraycount] = "Especificações"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "tipo de letra incorporada"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "Especificações do papel"
	
arraycount += 1
	
namesArray[arraycount] = "Folhas soltas"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "especificações"
...
namesArray[arraycount] = "Formulários de várias vias"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "Especificações"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "Impressão bidireccional (Bi-d)"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "Impressão unidireccional (Uni-d)"
	
arraycount += 1
	
namesArray[arraycount] = "Impressora"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00100"
descArray[arraycount] = "partilhar"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_1.htm#S-00600-00100"
descArray[arraycount] = "Indicação de erro"
...
descArray[arraycount] = "Limpar a impressora"
...
namesArray[arraycount] = "Listas de comandos"
urlsArray[arraycount] = "apspe_3.htm#S-00900-00300-00100"
descArray[arraycount] = "ESC/P"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00300"
descArray[arraycount] = "Micro-ajuste"
...
descArray[arraycount] = "Modo bidireccional I/F (interface) paralela"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01900"
descArray[arraycount] = "Modo de baixo ruído"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_2.htm#S-00500-00300"
descArray[arraycount] = "Modo de bloqueio"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00200"
descArray[arraycount] = "Modo de configuração"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01200"
descArray[arraycount] = "Modo de pacote"
	
arraycount += 1
	
namesArray[arraycount] = "Modo de suspensão"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100-00300"
descArray[arraycount] = "operações do painel"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00900"
descArray[arraycount] = "Modo I/F (interface)"
	
arraycount += 1
	
namesArray[arraycount] = "Opções"
urlsArray[arraycount] = "optn_1.htm#S-00800-00100-00100"
descArray[arraycount] = "suporte de rolo de papel"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "Painel"
	
arraycount += 1
	
namesArray[arraycount] = "painel de controlo"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "indicadores luminosos"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "Painel de controlo"
...
namesArray[arraycount] = "Papel contínuo"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "especificações"
...
descArray[arraycount] = "impressão"
	
arraycount += 1
	
namesArray[arraycount] = "Papel em rolo"
urlsArray[arraycount] = "optn_1.htm#S-00800-00100-00100"
descArray[arraycount] = "imprimir"
...
descArray[arraycount] = "Paridade"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02300"
descArray[arraycount] = "Período de espera de alimentação manual"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01000"
descArray[arraycount] = "Período de espera I/F Auto (interface)"
	
arraycount += 1
	
namesArray[arraycount] = "Predefinições"
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100"
descArray[arraycount] = "lista de opções"
	
arraycount += 1
	
namesArray[arraycount] = "Puxador"
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "impressora"
	
arraycount += 1
	
namesArray[arraycount] = "Resolução de problemas"
urlsArray[arraycount] = "trble_3.htm#S-00600-00300"
descArray[arraycount] = "problemas USB"
	
arraycount += 1
	
namesArray[arraycount] = "Resolução de problemas"
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "resolver encravamentos de papel"
	
arraycount += 1
	
namesArray[arraycount] = "Retirar"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00200"
descArray[arraycount] = "documento impresso do"
	
arraycount += 1
	
namesArray[arraycount] = "Rolo de papel"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "especificações"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "custo_2.htm#S-00700-00200-00100"
descArray[arraycount] = "Serviço de assistência a clientes"
...
descArray[arraycount] = "predefinição"
...
namesArray[arraycount] = "Tabela de caracteres"
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02100"
descArray[arraycount] = "configuração"
...
namesArray[arraycount] = "Tabela de caracteres IBM"
...
descArray[arraycount] = "Temporizador"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02200"
descArray[arraycount] = "Tipo de letra"
	
arraycount += 1
	
namesArray[arraycount] = "Tipo de letra incorporada"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "lista"
	
arraycount += 1
	
namesArray[arraycount] = "Tipo de letra incorporado"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100-00200"
descArray[arraycount] = "seleccionar"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_6.htm#S-00900-00600"
descArray[arraycount] = "Transportar a impressora"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01500"
descArray[arraycount] = "Velocidade de transmissão"
...
document.write("<title>Resultados da procura</title><body bgcolor=white>");
