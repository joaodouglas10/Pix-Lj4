...
function searchLinks(links, keyword){
	...
	document.writeln("<meta NAME=\"Version\" CONTENT=\"BPS0132-01 TR\">");
	document.writeln("<title>Arama Sonuçları</title>");
	...
	document.writeln("<div class=\"extra-head\">Arama Sonuçları</div>");

	document.writeln("<div class=\"extra-text\">");
	document.writeln("Arama sonuçları : <B>" +keyword.toUpperCase() +"</B>");
	...
	document.writeln("Aradığınız sonuçları bulamazsanız, Arama İpuçları'na bakın.");
	document.writeln("</div>");
	document.writeln("<div class=\"extra-link\">");
	
	document.writeln("<a href=\"javascript:goMain(\'sch.htm\')\">Arama İpuçları</a>");
...
descArray[arraycount] = "Baud hızı"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_6.htm#S-00400-00900"
descArray[arraycount] = "Bi-D Adjustment (Bi-D Ayarı)"
	
arraycount += 1
	
namesArray[arraycount] = "Çok yapraklı formlar"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "teknik özellikler"
	
arraycount += 1
	
namesArray[arraycount] = "Çok yapraklı formlar"
urlsArray[arraycount] = "paper_3.htm#S-00300-00500-00100"
descArray[arraycount] = "yazdırma"
	
arraycount += 1
	
namesArray[arraycount] = "Çıkarma"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00200"
descArray[arraycount] = "belge yazdırma yeri"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00200"
descArray[arraycount] = "Delikli yırtma yerini atla"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_5.htm#S-00600-00500"
descArray[arraycount] = "Dikey çizgileri hizalama"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00100"
descArray[arraycount] = "Dişli besleyici için sayfa uzunluğu"
	
arraycount += 1
	
namesArray[arraycount] = "Düğme"
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "yazıcı"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "Düğmeler"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02300"
descArray[arraycount] = "Elle besleme bekleme süresi"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "custo_2.htm#S-00700-00200-00100"
descArray[arraycount] = "Epson'a başvurma"
...
descArray[arraycount] = "erişme"
	
arraycount += 1
	
namesArray[arraycount] = "EPSON Status Monitor 3"
urlsArray[arraycount] = "soft_5.htm#S-00400-00500-00100"
descArray[arraycount] = "kurulum"
...
descArray[arraycount] = "İçi eğik çizgili 0"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "İki yönlü (Bi-d) yazdırma"
	
arraycount += 1
	
namesArray[arraycount] = "İstemci"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00300"
descArray[arraycount] = "Windows 7, Vista, XP veya 2000 ile"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "Işıklar"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02200"
descArray[arraycount] = "İtalik tablosu için uluslararası karakter seti"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00700"
descArray[arraycount] = "Kağıt hizalama"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "Kağıt sıkışması, temizleme"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "Kağıt teknik özellikleri"
	
arraycount += 1
	
namesArray[arraycount] = "Kaldırma"
urlsArray[arraycount] = "soft_10.htm#S-00400-00800"
descArray[arraycount] = "yazıcı yazılımı"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02000"
descArray[arraycount] = "Kapanma zamanlayıcısı"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01400"
descArray[arraycount] = "Karakter Sıklığı"
	
arraycount += 1
	
namesArray[arraycount] = "Karakter tablosu"
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02100"
descArray[arraycount] = "ayar"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_5.htm#S-00600-00500"
descArray[arraycount] = "Kendini sınama"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_2.htm#S-00500-00300"
descArray[arraycount] = "Kilit modu"
	
arraycount += 1
	
namesArray[arraycount] = "Komut listesi"
urlsArray[arraycount] = "apspe_3.htm#S-00900-00300-00100"
descArray[arraycount] = "ESC/P"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_1.htm#S-00600-00100"
descArray[arraycount] = "Kontrol paneli"
...
namesArray[arraycount] = "Kontrol paneli"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "düğmeler"
...
namesArray[arraycount] = "Kontrol paneli"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "ışıklar"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00500"
descArray[arraycount] = "Mikro ayar"
...
descArray[arraycount] = "Paralel I/F (arabirim) iki yönlü modu"
	
arraycount += 1
	
namesArray[arraycount] = "Rulo kağıt"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "teknik özellikler"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "optn_1.htm#S-00800-00100-00100"
descArray[arraycount] = "Rulo kağıt tutucu"
	
arraycount += 1
	
namesArray[arraycount] = "Seçenekler"
urlsArray[arraycount] = "optn_1.htm#S-00800-00100-00100"
descArray[arraycount] = "rulo kağıt tutucu"
...
descArray[arraycount] = "Şerit kartuşu"
...
descArray[arraycount] = "Sesli uyarıcı ayarı"
	
arraycount += 1
	
namesArray[arraycount] = "Sorun giderme"
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "kağıt sıkışmasını temizleme"
	
arraycount += 1
	
namesArray[arraycount] = "Sorun giderme"
urlsArray[arraycount] = "trble_3.htm#S-00600-00300"
descArray[arraycount] = "USB sorunları"
...
namesArray[arraycount] = "Sunucu"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00200"
descArray[arraycount] = "Windows 7, Vista, XP veya 2000 ile"
	
arraycount += 1
	
namesArray[arraycount] = "Sürekli kağıt"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "teknik özellikler"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_2.htm#S-00400-00200"
descArray[arraycount] = "Sürücü (yazıcı sürücüsü)"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "custo_2.htm#S-00700-00200-00100"
descArray[arraycount] = "Teknik destek"
	
arraycount += 1
	
namesArray[arraycount] = "Teknik özellikler"
...
namesArray[arraycount] = "Teknik özellikler"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "karakter tabloları"
	
arraycount += 1
	
namesArray[arraycount] = "Teknik özellikler"
urlsArray[arraycount] = "apspe_3.htm#S-00900-00300-00100"
descArray[arraycount] = "komut listeleri"
...
descArray[arraycount] = "ortam"
	
arraycount += 1
	
namesArray[arraycount] = "Teknik özellikler"
urlsArray[arraycount] = "apspe_4.htm#S-00900-00400"
descArray[arraycount] = "standartlar ve onaylar"
	
arraycount += 1
	
namesArray[arraycount] = "Teknik özellikler"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "uluslararası karakter setleri"
	
arraycount += 1
	
namesArray[arraycount] = "Teknik özellikler"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "yerleşik yazı tipi"
	
arraycount += 1
	
namesArray[arraycount] = "Tek sayfa"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "teknik özellikler"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "Tek yönlü (Uni-d) yazdırma"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00900"
descArray[arraycount] = "USB arabirimi"
	
arraycount += 1
	
namesArray[arraycount] = "USB arabirimi"
urlsArray[arraycount] = "trble_3.htm#S-00600-00300"
descArray[arraycount] = "sorunlar"
	
arraycount += 1
	
namesArray[arraycount] = "Uyku modu"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100-00300"
descArray[arraycount] = "panel işlemleri"
	
arraycount += 1
	
namesArray[arraycount] = "Varsayılan ayarlar"
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100"
descArray[arraycount] = "seçenek listesi"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00200"
descArray[arraycount] = "Varsayılan ayar modu"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-01700"
descArray[arraycount] = "Veri uzunluğu"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "Yazdırma yönü"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_9.htm#S-00400-00700"
descArray[arraycount] = "Yazdırmayı iptal etme"
	
arraycount += 1
	
namesArray[arraycount] = "Yazıcı"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00100"
descArray[arraycount] = "paylaşma"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_7.htm#S-00400-01000"
descArray[arraycount] = "Yazıcı Ayarı"
	
arraycount += 1
	
namesArray[arraycount] = "Yazıcı sürücüsü"
urlsArray[arraycount] = "soft_4.htm#S-00400-00400"
descArray[arraycount] = "ayarlar"
...
namesArray[arraycount] = "Yazıcı sürücüsü"
urlsArray[arraycount] = "soft_10.htm#S-00400-00800"
descArray[arraycount] = "kaldırma"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_6.htm#S-00900-00600"
descArray[arraycount] = "Yazıcıyı taşıma"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_5.htm#S-00900-00500"
descArray[arraycount] = "Yazıcıyı temizleme"
	
arraycount += 1
	
namesArray[arraycount] = "Yazılım"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02200"
descArray[arraycount] = "Yazı tipi"
	
arraycount += 1
	
namesArray[arraycount] = "Yerleşik yazı tipi"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "liste"
...
descArray[arraycount] = "seçme"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600"
descArray[arraycount] = "Yırtma"
	
arraycount += 1
	
namesArray[arraycount] = "Yırtma"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00300"
descArray[arraycount] = "ayarlama"
	
arraycount += 1
	
namesArray[arraycount] = "Yırtma"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00100"
descArray[arraycount] = "düğme"
	
arraycount += 1
	
namesArray[arraycount] = "Yırtma"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00200"
descArray[arraycount] = "otomatik"
	
arraycount += 1
	
namesArray[arraycount] = "Zarflar"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "teknik özellikler"
...
document.write("<title>Arama Sonuçları</title><body bgcolor=white>");
